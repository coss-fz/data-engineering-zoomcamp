...
I just had to look for the file in the bucket `gs://jcf-kestra-bckt/yellow_tripdata_2020-12.csv`
...
I just had to look for the label `file` in the backfill execution for the `green` input fro those parameters.
...
See [here](https://vscode.dev/github/coss-fz/data-engineering-zoomcamp/blob/master/hw-02-workflow-orchestration/gcp_taxi_scheduled.yaml#L242).
