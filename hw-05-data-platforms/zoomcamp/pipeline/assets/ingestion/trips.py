...
def materialize():
    ...
    extracted_at = str(datetime.now())  # Convert to string immediately
    ...
    for taxi_type in taxi_types:
        for year, month in months:
            ...
            try:
                ...
                # Convert datetime columns to strings to avoid PyArrow timezone issues on Windows
                # Staging layer will convert them back to timestamps
